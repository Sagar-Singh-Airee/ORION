...
from orion.data.datasets import KneeMRIDataset, variable_length_collate
...
def main() -> None:
    ...
    dataset = KneeMRIDataset(cfg, split="test")
    ...
    ids, probabilities = Predictor(model).predict_loader(loader)  # type: ignore[union-attr]
